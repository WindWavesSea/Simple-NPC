execute if score #custom_settings windwaves_sea.npc.system > #max_custom_settings windwaves_sea.npc.system run return 1
...
function npc:debug/execute/get_setting0 with storage windwaves_sea:npc temp.debug
...
function npc:debug/execute/custom_true